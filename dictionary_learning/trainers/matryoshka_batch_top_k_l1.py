...
class MatryoshkaBatchTopKTrainerL1(MatryoshkaBatchTopKTrainer):
    ...
    def loss(self, x, step=None, logging=False):
        ...
        weight_norm = self.ae.W_enc.abs().sum() + self.ae.W_dec.abs().sum()
    ...
    def config(self):
        ...
        config["trainer_class"] = "MatryoshkaBatchTopKTrainerL1"
